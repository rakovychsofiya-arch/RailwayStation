    ...
    <div className="train-card">
      ...
      <div className="train-info">
        <div className="time-block">
          <p>Відправлення: <strong>{new Date(train.departure).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</strong></p>
          <p>Прибуття: {new Date(train.arrival).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</p>
        </div>
